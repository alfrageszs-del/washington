-- =====================================================
-- ПОЛНЫЙ СКРИПТ ИСПРАВЛЕНИЯ СИСТЕМЫ ЮРИДИЧЕСКИХ ДОКУМЕНТОВ
-- =====================================================
...
WHERE table_name IN ('cases', 'court_acts', 'court_sessions', 'case_participants', 'case_documents', 'case_events')
