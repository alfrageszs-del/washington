...
export default function EditCourtActPage({ params }: { params: { id: string } }) {
  const { id } = params;
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6">
      <h1 className="text-2xl font-bold">Редактирование судебного акта</h1>
